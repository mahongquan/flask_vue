...
class PartsPackitem(Base):
    ...
    def json(self):
        dic1={}
        dic1["pack_id"]=self.pack_id
        dic1["item_id"]=self.item_id
        dic1["ct"]=self.ct
        dic1["quehuo"]=self.quehuo
        dic1["name"]=self.item.name
        dic1["guige"]=self.item.guige
        dic1["bh"]=self.item.bh
        dic1["id"]=self.id
        return dic1
